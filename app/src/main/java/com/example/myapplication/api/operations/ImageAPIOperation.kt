...
class ImageAPIOperation internal constructor(listener: IObtainImageListener, override val url: String, val width : Int, val height: Int) : APIOperation<APIResult<Bitmap>, Bitmap, IObtainImageListener>(listener) {
    ...
    companion object {
        fun obtainImage(listener: IObtainImageListener, url: String, width: Int, height: Int) =
